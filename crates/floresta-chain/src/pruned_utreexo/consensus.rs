...
mod tests {
    ...
    fn final_transaction_checks_time_locks_strictly() {
        ...
        assert!(Consensus::is_final_transaction(&below_cutoff, 100, cutoff));
        assert!(!Consensus::is_final_transaction(&at_cutoff, 100, cutoff));
        assert!(!Consensus::is_final_transaction(&above_cutoff, 100, cutoff));
    }
